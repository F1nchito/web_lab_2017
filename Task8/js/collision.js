...
AIRAPP.set('manager_collision', function () {
    ...
    function macroCollision(obj1, obj2) {
        ...
        if (obj1.position[0] + obj1.size[0] >= obj2.position[0] && obj1.position[0] <= obj2.position[0] + obj2.size[0]) {
            XColl = true;
        }
        if (obj1.position[1] + obj1.size[1] >= obj2.position[1] && obj1.position[1] <= obj2.position[1] + obj2.size[1]) {
            YColl = true;
        }
